 ...
 * 
 * @see cl.mycompany.acceso.modelo.Rol
...
public class RolDAO {
	...
	/**
	 * Perform an initial save of a previously unsaved Rol entity. All
	...
	/**
	 * Delete a persistent Rol entity. This operation must be performed within
	...
	/**
	 * Persist a previously saved Rol entity and return it or a copy of it to
	 * the sender. A copy of the Rol entity parameter is returned when the JPA
	...
	public Rol findById(Integer id) {
		EntityManagerHelper.log("finding Rol instance with id: " + id,
				Level.INFO, null);
		try {
	 ...
	 * 
	 * @param propertyName
	 *            the name of the Rol property to query
	 * @param value
	...
	public List<Rol> findByProperty(String propertyName, final Object value,
		...
		EntityManagerHelper.log("finding Rol instance with property: "
	...
	public List<Rol> findByNombre(Object nombre, int... rowStartIdxAndCount) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<Rol> findAll(final int... rowStartIdxAndCount) {
